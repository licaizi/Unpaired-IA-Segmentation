...
import torch
from models import Multi_Modal_Seg
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='cycle_image_transfer', help='chooses which model to use. cycle_gan')

        parser.add_argument('--which_direction', type=str, default='AtoB', help='AtoB or BtoA (keep it AtoB)')
        parser.add_argument('--checkpoints_dir', type=str, default='../../checkpoints/Image_translate/day7_cycleGan', help='models are saved here')
    ...
    def gather_options(self):
        ...
        # print(model_name)
        model_option_setter = Multi_Modal_Seg.get_option_setter(model_name)
    ...
    def parse(self):
        ...
        # print('.........',opt.no_dropout,opt.resample)
