...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--lr_decay_iters', type=int, default=60, help='multiply by a gamma every lr_decay_iters iterations')
        ...
        parser.add_argument('--trg_train_num', type=int, default=37,
                            help='the number of training data', )
        parser.add_argument('--pretrain_seg', type=bool, default=True,
        ...
        parser.add_argument('--pretrained_G_path', type=str,
                            default='/home/hci/ruiqiang/DA/cta-projects-main/cta-seg/checkpoints/Image_translate/day10_image_transfer_BN_dropout_nolsGAN_diflr_Gfirst/experiment_name/latest_net_G.pth',
                            help='path of the pretrained generator model', )
        parser.add_argument('--pretrained_D_path', type=str,
                            default='/home/hci/ruiqiang/DA/cta-projects-main/cta-seg/checkpoints/Image_translate/day10_image_transfer_BN_dropout_nolsGAN_diflr_Gfirst/experiment_name/latest_net_D.pth',
                            help='path of the pretrained segmentation model', )
        ...
        parser.add_argument('--norm_type', type=str, default='z-score', help='max-min or max-abs,for normalization')
        parser.add_argument('--Pre_train', default=False, help='whether use the pretrained G and D')
